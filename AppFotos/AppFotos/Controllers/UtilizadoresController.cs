...
namespace AppFotos.Controllers
{
    public class UtilizadoresController : Controller
    {
        ...
        {
            //procurar na base de dados todos os utilizadores e listá-los
            //entregando, de seguida, esses dados á View
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //não esquecer
            //ADEQUAR O NOME DAS VARIAVEIS ÁS SUAS FUNCOES
            //TODAS!!!!!!!! TODAS !!!!!! AFDSPDMCMCS  SCM PSMCPISNKS
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Morada,CodPostal,Pais,NIF,Telemovel")] Utilizadores utilizador)
        {
            ...
            {
                //certifica que o o texto do código postal é convertido para maiúsculas
